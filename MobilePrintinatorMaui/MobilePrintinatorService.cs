#if ANDROID
using Java.Util;
using MobilePrintinatorMaui.Platforms.Android;
#endif
...
namespace MobilePrintinatorMaui
{
    public class MobilePrintinatorService : IMobilePrintinatorService
    {
        ...
        public void Configure(PrinterProperties properties)
        {
            ...
            {
#if ANDROID
                m_driver = new MobilePrintinatorMaui.Platforms.Android.ESCPOSDriver(((ESCPOSPrinterProperties)properties).printerName);
#elif WINDOWS
                m_driver = new MobilePrintinatorMaui.Platforms.Windows.ESCPOSDriver();
#endif
                if (m_driver != null)
                {
